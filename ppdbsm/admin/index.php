...
if(isset($_POST['login']))
{
    ...
    }else if($baris1['role']=="kepalasekolah"){
        echo "<script>document.location='../admin/dashboard.php';</script>";}
        else{
...
<head>
    ...
    <link rel="stylesheet" href="../asset/sbadmin/js/my.js">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block center"><img src="../../img/5124556.jpg" width="120%" alt="" srcset=""></div>
                            <div class="col-lg-6">
                                <div class="p-5">
