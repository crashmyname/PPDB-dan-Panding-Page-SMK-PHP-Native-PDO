...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <p class="mb-4">Berikut adalah halaman data Guru SMK Mahakarya Cikupa.</p>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                <a href="form_guru.php" class="btn btn-success float-right">Tambah</a>
            </div>
            <div class="card-body">
                <div class="table-responsive" id="">
                    <table class="table table-bordered" id="table-datatables" width="100%" cellspacing="0">
                        ...
                        <tr align="center">
                            <th><?= $no;?></th>
                            <th><?= $baris['nip']?></th>
                            <th><?= $baris['nama_guru']?></th>
                            <th><?= $baris['jk']?></th>
                            <th><?= $baris['alamat']?></th>
                            <th><?= $baris['gelar']?></th>
                            <th><a href="form_eguru.php?id=<?= $baris['id_guru']?>"><svg
                                ...
                                <a href="trash/d_guru.php?id=<?= $baris['id_guru']?>"
