...
<div class="container-fluid">        
            ...
            <div class="card card-info col-12">
                <div class="card-header">
                    <h3 class="card-title">Tambah Extrakurikuler</h3>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="file" name="gmbr_ex" class="form-control" placeholder="Gambar Ekskul" value="" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Caption" class="col-sm-4 col-form-label">Extrakurikuler</label>
                                <div class="col-sm-8">
                                    <input type="text" name="nama_ex" class="form-control" id="nama" placeholder="Masukin Extrakurikuler" value="" required>
                                </div>
                            </div>
